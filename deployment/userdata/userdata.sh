...
git clone -b develop https://github.com/saifudheenvk/chatty-backend.git # replace this github url with your url of your own project
cd chatty-backend # set your project name
npm install
aws s3 sync s3://chatty-app-env-files/backend/develop . # update with your s3 bucket
unzip env-file.zip
cp .env.develop .env
npm run build
npm run start
